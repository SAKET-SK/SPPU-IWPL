 ...
 * 
 */
@WebServiceClient(name = "MyServer", targetNamespace = "http://skcalc.com/", wsdlLocation = "http://localhost:8080/MyCalc/MyServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVER_QNAME = new QName("http://skcalc.com/", "MyServer");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MyCalc/MyServer?wsdl");
    ...
    public MyServer getMyServerPort() {
        return super.getPort(new QName("http://skcalc.com/", "MyServerPort"), MyServer.class);
    }
    ...
    public MyServer getMyServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://skcalc.com/", "MyServerPort"), MyServer.class, features);
    }
